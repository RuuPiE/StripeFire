    ...
    customers: function (ref, callback, accessToken, alterRequest) {
      ...
      return {
        ...
        subscriptions: function (ref, callback, accessToken, alterRequest) {
          ...
          subscriptionsRef.on('child_added', Customer.create(customersRef, 'Subscription', ['plan', 'coupon', 'prorate', 'trial_end', 'card', 'quantity', 'application_fee_percent', 'metadata'], callback, accessToken, alterRequest));
